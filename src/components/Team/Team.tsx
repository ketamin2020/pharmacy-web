...
export const Team = () => {
  ...
  return (
    <Wrapper>
      <Typography>
        Команда електронної медичної інформаційної системи {window.location.host} - це люди, закохані в свою справу. Ми
        зібралися разом, щоб переосмислити образ аптечних мереж, щоб викорінити недостовірність інформування в медицині
        і щоб зробити здоров&apos;я трендом, а не тим, про що намагаються не говорити.
      </Typography>
      <Typography>
