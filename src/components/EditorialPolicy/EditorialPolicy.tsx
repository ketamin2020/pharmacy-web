...
export const EditorialPolicy = () => {
  ...
  return (
    <Wrapper>
      <Typography>
        Ми знаємо, що довіру потрібно заслужити, тому вважаємо за необхідне розповісти, як {window.location.host}{' '}
        створює точний, зрозумілий, актуальний і науково доведений контент.
      </Typography>
      <Typography>
        Знайти інформацію про здоров&apos;я і благополуччя в інтернеті дуже просто — вона є всюди. Але знайти
        достовірну, актуальну і корисну інформацію — складно і навіть утомливо. {window.location.host} все змінює. Ми
        робимо інформацію про здоров&apos;я зрозумілою і доступною, щоб ви могли приймати оптимальні та медично
        обґрунтовані рішення щодо свого здоров&apos;я і здоров&apos;я своїх близьких.
      </Typography>
      <h3>Сфери регулювання редакційної політики</h3>
      <Typography>
        Існуюча редакційна політика {window.location.host} регулює такі сфери діяльності і комунікації веб-сайту{' '}
        {window.location.host} (далі — Сайт) з клієнтами:
      </Typography>
      <List>
      ...
      <Typography>
        Принципи {window.location.host}, якими ми керуємося у своїй роботі і які організовують і визначають всі сфери
        регулювання редакційної політики, такі::
      </Typography>
      ...
      <Typography>
        {window.location.host} несе повну відповідальність за всі матеріали та інформацію, опубліковані на Сайті. Ми
        гарантуємо достовірність, релевантність, надійність і актуальність всіх матеріалів, розміщених на Сайті.
      </Typography>
      ...
      <Typography>
        ...
        входить в редакторську команду {window.location.host}.
      </Typography>
      <h4>№6 Джерела інформації</h4>
      <Typography>До джерел інформації на сайті {window.location.host} відносяться:</Typography>
      <Typography>
      ...
      <h4>№9 Доступність</h4>
      <Typography>
        Вся інформація, розміщена на Сайті {window.location.host}, повинна бути доступною і зрозумілою для широких мас
        населення. Не допускається використання двозначних, неуточнених і розмитих слів, фраз і виразів, а також
        термінології вузької спеціалізації без роз&apos;яснення і уточнення смислової і семантичної спрямованості.
      </Typography>
      <Typography>
      ...
      <Typography>
        Редакція і медичні експерти {window.location.host} прагнуть створювати якісний, актуальний, корисний і
        достовірний контент, дотримуючись найвищих журналістських стандартів в галузі медицини і здоров&apos;я. Ми
        прагнемо надати вичерпні, неупереджені, чесні і своєчасні рекомендації та практичні поради, новини та огляди,
        керівництва та інструкції.
      </Typography>
      <h4>Наша команда медичних експертів</h4>
      <Typography>
        Медичний контент {window.location.host} створюється на підставі фактів, наукових даних і офіційних або
        перевірених джерел, а також перевіряється кваліфікованими авторами, редакторами, лікарями, фармацевтами та
        іншими фахівцями-консультантами команди, які поділяють і підтримують погляди нашої редакції.
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        благополуччя в блозі {window.location.host} перевіряються групою професійних медиків, фармацевтів або редакторів
        для забезпечення точності, достовірності, актуальності та релевантності.
      </Typography>
      ...
      <h4>Наші автори</h4>
      <Typography>
        {window.location.host} ретельно оцінює всіх потенційних авторів статей про здоров&apos;я і благополуччя. Перш,
        ніж ми опублікуємо статтю, ми обов&apos;язково повинні переконатися, що автори контенту є фахівцями в предметній
      ...
      <Typography>
        Редакція {window.location.host} постійно стежить за змінами в медичній, науковій та соціокультурній сферах. З
        появою нової інформації ми оновлюємо статті.
      </Typography>
      ...
      <Typography>
        Картка товарів кожного препарату містить його аналоги. Підбір аналогів лікарського засобу на сайті{' '}
      ...
      <Typography>
        ...
        {window.location.host} на відповідність дійсності.
      </Typography>
      <h4>№7 Верифікація</h4>
      <Typography>
        ...
        медичних експертів {window.location.host}.
      </Typography>
      ...
      <Typography>
        ...
        Для того, щоб ознайомитися з редакційною політикою {window.location.host} натисніть на «Перевірено.
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        {window.location.host}, відповідає «Закону України «Про лікарські засоби» [Офіційне джерело] і «Закону України
        «Про авторське право і суміжні права» [Офіційне джерело],а також перевірена уповноваженим цензором. Оновлення
        інструкції на сайті {window.location.host} здійснюється після її поновлення на сайті Державного реєстра
        лікарських засобів України, або на офіційному сайті виробника.
      </Typography>
      <h4>№8 Оновлення</h4>
      <Typography>
      ...
      <Typography>
        Блог {window.location.host} включає не тільки медичні теми, а й теми розважального характеру. У такому випадку
        інформація, що міститься в ненаукових статтях, носить лише ознайомлювальний характер, може не збігатися з думкою
        редакції і не має на меті образити читача з іншою точкою зору. Розважальна інформація не претендує на істинність
        і обґрунтованість і може бути лише одним з існуючих в світі думок та ідеологій.
      </Typography>
      <h3>Конфлікт інтересів</h3>
      <Typography>
        {window.location.host} співпрацює з медичними експертами — лікарями, психологами, фармацевтами та іншими
        представниками сфери здоров&apos;я і благополуччя. Така співпраця в деяких аспектах може мати на увазі конфлікт
        інтересів.
      </Typography>
      <Typography>
        Конфлікт інтересів може полягати в тому, що деякі фахівці (фармацевти) є співробітниками {window.location.host}{' '}
        і отримують грошову винагороду за свою роботу, що може позначатися на їх позиціонуванні і подачі інформації в
        контенті сайту.
      </Typography>

      <Typography>
        {window.location.host} не несе відповідальність за особисту думку і позиціонування кожного фахівця, проте
        намагається мінімізувати свідомо неправдоподібну або не корисну інформацію для відвідувачів Сайту, відмовляючись
        від публікацій подібних статей..
      </Typography>
      <Typography>
      ...
      <Typography>
        Лікарі та інші фахівці з області здоров&apos;я і благополуччя співпрацюють з {window.location.host} на
        благодійних засадах і не отримують за свою діяльність фінансову винагороду, що не виключає, але значно знижує
        конфлікт інтересів.
      </Typography>
      <Typography>
      ...
      <Typography>
        {window.location.host} пропонує співпрацю медичним експертам на правах реклами — фармацевтам та лікарям різних
        спеціалізацій. Експерти, які бажають співпрацювати, можуть стати частиною редакторської команди медичних
        експертів {window.location.host}.
      </Typography>
      ...
      <Typography>
        Для домовленості про співпрацю необхідно написати на пошту головного редактора {window.location.host} Юлії
        Щербаченко — {main.support_email}.
      </Typography>
      ...
      <Typography>
        Інформація, яку ми надаємо на {window.location.host}, не призначена для заміни консультації з кваліфікованим
        медичним працівником — навіть найповніше інформування не є приводом для відміни відвідування лікаря. За всіма
        медичними питаннями для консультації, діагностування та призначення лікування необхідно звертатися до вашого
        лікаря.
      </Typography>
      ...
      <Typography>
        ...
        лікаря. Сайт {window.location.host} може ознайомити вас з питаннями здоров&apos;я, захворювань і лікування, але
        він не замінить діагностику і консультацію фахівця.
      </Typography>

      <Typography>
        Редакція {window.location.host} не несе відповідальність за недоцільне використання інформації відвідувачами
        сайту.
      </Typography>
    </Wrapper>
  )
